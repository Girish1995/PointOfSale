...
public class DrawerTransaction extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_drawer_transaction, container, false);
...
//                    android.R.anim.fade_out);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.fab:
                fun_firstFragment(new NewReason());
                break;
