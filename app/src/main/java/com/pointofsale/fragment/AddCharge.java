...
public class AddCharge extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
      //  return super.onCreateView(inflater, container, savedInstanceState);
        ...
        View v = inflater.inflate(R.layout.fragment_add_charge, container, false);
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.past_invoices:
                ...
                fun_firstFragment1(new MainDashboard.Sales());
                break;
